...
<div class="info1">
    <h2 class="elem__h1">Le beau footer</h2>
    <p class="elem__h2">Un site web fait par une élève du TIM à l'aide de Wordpress.</p>
    <h3 class="elem__p">Fait par Florence Lemieux Cayer</h3>
    </div>
<?php 
